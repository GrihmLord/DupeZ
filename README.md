...
build.bat
# Output: dist\dupez.exe + dist\DupeZ_v5.2.1_Setup.exe (installer)
```

### Install via Installer (Recommended)

Download `DupeZ_v5.2.1_Setup.exe` from [Releases](https://github.com/GrihmLord/DupeZ/releases). The installer:
