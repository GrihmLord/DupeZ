...
| File | Purpose |
| --- | --- |
| `release.ps1` | **Retired safety stub.** Refuses to tag or publish and points operators to the protected finalization, frozen/manual validation, draft staging, and publication sequence. |
