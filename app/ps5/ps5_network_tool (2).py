...
class PS5NetworkTool:
    ...
    def _get_bandwidth_usage(self, ip: str) -> Dict[str, float]:
        """Get bandwidth usage for PS5 device using real network monitoring"""
        try:
            ...
            if target_interface and target_interface in net_io:
                ...
                download = stats.bytes_recv / 1024.0  # Convert to KB
                upload = stats.bytes_sent / 1024.0    # Convert to KB
                ...
                download = overall_stats.bytes_recv / 1024.0
                upload = overall_stats.bytes_sent / 1024.0
                total = download + upload
